...
Apply AI_REDACT to the notes column and name the column "redacted_notes". Set target lag to 8 hours. Add it to line 44 of this file. Keep the existing comment above it.
*/
